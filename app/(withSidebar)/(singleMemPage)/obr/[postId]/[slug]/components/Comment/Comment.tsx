...
import ArticleTime from "@/app/(withSidebar)/(postsPages)/components/Post/components/ArticleTime";
import Badge from "@/app/(withSidebar)/(postsPages)/components/Post/components/Badge";
