...
const Voters: React.FC<VotersProps> = ({ voters, method }) => {
  ...
  return (
    <div className="relative flex items-center" ref={containerRef}>
      ...
      {isVisible && (
        <div className="absolute top-full left-[calc(50%-20px)] -translate-x-1/2 w-[215px] pt-[10px] z-11">
          <div
            className={clsx(
              "w-full p-[10px] bg-[#6e7578] text-white text-[12px] text-left rounded-[5px] shadow-md relative max-h-[250px]",
              "after:absolute after:bottom-full after:left-[calc(50%+18px)] after:-translate-x-1/2 after:border-[#6e7578] after:border-t-0 after:border-l-[5px] after:border-r-[5px] after:border-b-[5px] after:border-l-transparent after:border-r-transparent after:border-t-transparent"
            )}
          >
