...
const AnswersSection = <T extends FieldValues>({
  ...
  return (
    <div className="py-[25px] mb-[10px]">
      ...
      <div className="w-[calc(100%_+_20px)] pr-[20px] overflow-hidden overflow-y-auto max-h-[30vh] mb-[4px]">
      ...
      <div className="w-full flex items-center">
        <input
          className="w-[calc(80%_-_3px)] h-[34px] ml-[8%] mr-[3px] leading-[48px] bg-black p-[10px] text-white disabled:opacity-30 disabled:cursor-not-allowed placeholder:text-zinc-500 focus:outline-none"
        ...
        <button
          ...
          type="button"
          className="w-[calc(12%_-_3px)] bg-[#c23d3a] text-[12px] mr-0 h-[34px] leading-[34px] text-white text-center inline-block mx-[3px] hover:bg-[#732423] transition-colors duration-200 ease-in-out"
        >
          Dodaj
        </button>
      </div>
