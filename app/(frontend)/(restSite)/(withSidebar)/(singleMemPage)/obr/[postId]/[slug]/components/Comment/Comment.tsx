...
import ArticleTime from "@/app/(frontend)/(restSite)/(withSidebar)/(postsPages)/components/Post/components/ArticleTime";
import Badge from "@/app/(frontend)/(restSite)/(withSidebar)/(postsPages)/components/Post/components/Badge";
