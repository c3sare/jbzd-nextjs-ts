import Pagination from "@/app/(frontend)/(withSidebar)/(postsPages)/components/Pagination";
import Posts from "@/app/(frontend)/(withSidebar)/(postsPages)/components/Posts";
