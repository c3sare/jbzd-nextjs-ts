...
import ArticleTime from "@/app/(frontend)/(withSidebar)/(postsPages)/components/Post/components/ArticleTime";
import Badge from "@/app/(frontend)/(withSidebar)/(postsPages)/components/Post/components/Badge";
