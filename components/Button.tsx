  ...
  return (
    <div className={clsx(className ? className : "flex justify-end my-2")}>
      <button
        ...
        type={type || "button"}
        className={clsx(
          "w-full px-2 max-w-none rounded-[5px] font-normal text-[13px] outline-hidden h-[30px] disabled:opacity-80 disabled:bg-[#2d2d2d]",
      ...
      >
        <span className="relative">
          ...
          {(hookForm?.formState.isLoading || isLoadingComponent) && (
            <div className="absolute left-[calc(100%+8px)] top-[50%] translate-y-[-50%]">
